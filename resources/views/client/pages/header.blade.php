    ...
    <div class="humberger__menu__wrapper">
        <div class="humberger__menu__logo">
            <a href="#"><img src={{ asset('client/img/logo.png') }}></a>
        </div>
        ...
        <div class="humberger__menu__widget">
            <div class="header__top__right__language">
                <img src={{ asset('client/img/language.png') }}>
                <div>English</div>
            ...
            <div class="header__top__right__auth">
                {{-- <a href="{{ route('client.dangnhap') }}"><i class="fa fa-user"></i> Login</a> --}}
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <a href="./index.html"><img src={{ asset('client/img/logo.png') }}></a>
                    </div>
                </div>
                <div class="col-lg-6">
